...
?>
 ...
 <div class="menu">
  <dl>
   <dt><a href="linux-laptop.php">Linux on Toshiba Satellite 2100CDT</a></dt><dd>These pages document installs of several Linux distributions on my old Toshiba Satellite 2100CDT laptop. I don't use the machine anymore, but am keeping these pages online for those that need them. I still get the occasional email about them, so there is apparently some need still.</dd>
