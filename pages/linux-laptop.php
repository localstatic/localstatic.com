 ...
 <p>
  ...
  <a href="<?php print $_SERVER['SCRIPT_NAME']; ?>?p=linux-laptop-slackware">Slackware</a> - This was one of my first installs on this machine.<br/>
  <a href="<?php print $_SERVER['SCRIPT_NAME']; ?>?p=linux-laptop-redhat">RedHat</a> - I had to revisit my first distribution.  The installation has come quite far since then.<br/>
  <a href="<?php print $_SERVER['SCRIPT_NAME']; ?>?p=linux-laptop-debian">Debian</a> - This is my favorite distribution, and the one that I run on my primary machine.<br/>
 </p>
